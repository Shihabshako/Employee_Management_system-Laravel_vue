...
!(function (e, t) {
                    ...
                    this._addOverlay(),
                        ...
                        n.default
                            ...
                            .fail(function (t, a, i) {
                                if (
                                    (e._removeOverlay(),
                                    e._settings.loadErrorTemplate)
                                ) {
                                    var o = n
                                        .default(e._settings.errorTemplate)
                                        .text(i);
                                    e._parent
                                        .find(e._settings.content)
                                        .empty()
                ...
                (t._addOverlay = function () {
                    this._parent.append(this._overlay),
                        n
                            .default(this._element)
                            .trigger(
                                n.default.Event("overlay.added.lte.cardrefresh")
                            );
                }),
    ...
    n.default(document).on("click", r, function (e) {
        e && e.preventDefault(),
            f._jQueryInterface.call(n.default(this), "load");
    }),
        n.default(function () {
    ...
    n.default(document).on("click", C, function (e) {
        e && e.preventDefault(),
            I._jQueryInterface.call(n.default(this), "toggle");
    }),
                ...
                (t.show = function (e) {
                    ...
                    e && n.default(k).hide(),
                        ...
                        n
                            .default(this._element)
                            .trigger(
                                n.default.Event("expanded.lte.controlsidebar")
                            );
                }),
                (t.toggle = function () {
                        ...
                        this._isFooterFixed() &&
                            ...
                            "undefined" !=
                                ...
                                t.overlayScrollbars({
                                    ...
                                    scrollbars: {
                                        autoHide:
                                            this._config.scrollbarAutoHide,
                                        clickScrolling: !0,
                                    },
                                });
                    } else t.attr("style", "");
                    ...
                    this._element.siblings().show().toggleClass("show"),
                        ...
                        this._element
                            ...
                            .on("hidden.bs.dropdown", function () {
                                n.default(".dropdown-submenu .show")
                                    .removeClass("show")
                                    .hide();
                            });
                }),
                ...
                (t.init = function () {
                    n.default(Z).each(function (e, t) {
                        ...
                        "true" === a
                            ...
                            : "false" === a &&
                              (i.hide(),
                              i.parent().parent().addClass("d-none"));
                    });
                }),
    ...
    var ae = "Fullscreen",
        ...
        re = (function () {
            function e(e, t) {
                (this.element = e),
                    (this.options = n.default.extend({}, se, t));
            }
            var t = e.prototype;
            return (
                (t.toggle = function () {
            ...
            return (
                ...
                (t.openTabSidebar = function (e, t) {
                    ...
                    if ("#" !== o && "" !== o && void 0 !== o) {
                        ...
                        if (
                            !this._config.allowDuplicates &&
                            n.default("#" + s).length > 0
                        )
                            return this.switchTab(
                                "#" + s,
                                this._config.allowReload
                            );
                        ((!this._config.allowDuplicates &&
                        ...
                        this._config.loadingScreen
                            ? l.show(0, function () {
                                  n.default(o + " iframe")
                                      .attr(
                                          "src",
                                          n.default(o + " iframe").attr("src")
                                      )
                                      .ready(function () {
                                          a._config.loadingScreen &&
                                              ("number" ==
                                              typeof a._config.loadingScreen
                                                  ? setTimeout(function () {
                                                        l.fadeOut();
                                                    }, a._config.loadingScreen)
                                                  : l.fadeOut());
                ...
                (t.removeActiveTab = function (e, t) {
                    if ("all" == e)
                        ...
                        if (
                            ...
                            var r = l - 1;
                            this.switchTab(
                                o.children().eq(r).find("a.nav-link")
                            );
                        }
                    } else {
                        ...
                        if (
                            ...
                            var c = u - 1;
                            this.switchTab(
                                f.children().eq(c).find("a.nav-link")
                            );
                        }
                    }
                }),
                        ...
                        n.default(he).hasClass(Se) &&
                            (n
                                ...
                                .on(
                                    ...
                                    function (t) {
                                        t.preventDefault(),
                                            e.openTabSidebar(t.target);
                                    }
                                ),
                            this._config.useNavbarItems &&
                                n
                                    .default(document)
                                    .on("click", Ie + ", " + Te, function (t) {
                                        t.preventDefault(),
                                            e.openTabSidebar(t.target);
                                    })),
                        n.default(document).on("click", _e, function (t) {
                            t.preventDefault(),
                                e.onTabClick(t.target),
                                e.switchTab(t.target);
                        }),
                        n.default(document).on("click", _e, function (t) {
                            t.preventDefault(),
                                e.onTabClick(t.target),
                ...
                (t._setItemActive = function (e) {
                    ...
                    var t = n.default(Ie + '[href$="' + e + '"]'),
                        a = n.default(
                            '.main-header a.dropdown-item[href$="' + e + '"]'
                        ),
                ...
                (e._jQueryInterface = function (t) {
                    if (n.default(ue).length > 0) {
                        ...
                        new e(
                            n.default(this),
                            JSON.parse(
                                localStorage.getItem("AdminLTE:IFrame:Options")
                            )
                        )._initFrameElement();
                }),
                e
            ...
            return (
                (t.fixLayoutHeight = function (e) {
                    ...
                    (t.hasClass("control-sidebar-slide-open") ||
                        ...
                        "control_sidebar" === e) &&
                        (a = n
                            .default(".control-sidebar-content")
                            .outerHeight());
                    var i = {
                            window: n.default(window).height(),
                            header:
                                n.default(Fe).length > 0
                                    ? n.default(Fe).outerHeight()
                                    : 0,
                            footer:
                                n.default(De).length > 0
                                    ? n.default(De).outerHeight()
                                    : 0,
                            sidebar:
                                n.default(Le).length > 0
                                    ? n.default(Le).height()
                                    : 0,
                            controlSidebar: a,
                        },
                ...
                (t.fixLoginRegisterHeight = function () {
                    ...
                    if (e.hasClass("iframe-mode"))
                        ...
                        e.css("height", "auto"),
                            n.default("html").css("height", "auto");
                    else {
                        var a = t.height();
                ...
                (t._init = function () {
                    ...
                    this.fixLayoutHeight(),
                        ...
                        setTimeout(function () {
                            n.default("body.hold-transition").removeClass(
                                "hold-transition"
                            );
                        }, 50),
                        setTimeout(function () {
            ...
            return (
                ...
                (e._jQueryInterface = function (t) {
                    return this.each(function () {
                        ...
                        a ||
                            ((a = new e(this, i)), n.default(this).data(Oe, a)),
                            "string" == typeof t &&
    ...
    var Xe = "SidebarSearch",
        ...
        ht = (function () {
            ...
            return (
                (a.init = function () {
                    ...
                    0 !== n.default(ot).length &&
                        (0 === n.default(ot).next(dt).length &&
                            n
                                .default(ot)
                                .after(n.default("<div />", { class: nt })),
                        0 === n.default(dt).children(".list-group").length &&
                            n
                                .default(dt)
                                .append(n.default("<div />", { class: it })),
                        this._addNotFound(),
                        n
                ...
                (a.toggle = function () {
                    n.default(ot).parent().hasClass(et)
                        ? this.close()
                        : this.open();
                }),
                (a._parseItem = function (e, t) {
                    ...
                    if (
                        (void 0 === t && (t = []),
                        !n.default(e).hasClass("nav-header"))
                    ) {
                        var i = {},
                ...
                (a._renderItem = function (e, t, a) {
                    ...
                    var s = n.default("<a/>", {
                        ...
                        r = n
                            .default("<div/>", { class: "search-title" })
                            .html(e),
                        d = n
                            .default("<div/>", { class: "search-path" })
                            .html(a);
                ...
                (e._jQueryInterface = function (t) {
                    ...
                    n.default(this).data(Ye, "object" == typeof t ? t : a),
                        "string" == typeof t &&
                        /init|toggle|close|open|search/.test(t)
                            ? o[t]()
                            : o.init();
                }),
                e
    ...
    n.default(document).on("click", st, function (e) {
        ...
        n.default(document).on("keyup", lt, function (e) {
            return 38 == e.keyCode
                ? (e.preventDefault(),
                  void n.default(ft).children().last().focus())
                : 40 == e.keyCode
                ? (e.preventDefault(),
                  void n.default(ft).children().first().focus())
    ...
    var gt = "NavbarSearch",
        ...
        Ct = (function () {
            function e(e, t) {
                (this._element = e),
                    (this._config = n.default.extend({}, yt, t));
            }
            var t = e.prototype;
            return (
                (t.open = function () {
                ...
                (t.create = function () {
                    ...
                    e.append(t),
                        null != this._config.body &&
                            e.append(
                                n
                                    .default('<div class="toast-body" />')
                                    .html(this._config.body)
                            ),
                        ...
                        this._config.autoremove &&
                            e.on("hidden.bs.toast", function () {
                                n.default(this).delay(200).remove(),
                                    o.trigger(
                                        n.default.Event("removed.lte.toasts")
                                    );
                            });
                }),
        ...
        $t = (function () {
            ...
            return (
                ...
                (t.toggle = function (e) {
                    ...
                    if (
                        i.is(qt) ||
                        (a.is(Mt) || (i = a.parent().find("> .nav-treeview")),
                        i.is(qt))
                    ) {
                        e.preventDefault();
                ...
                (t._expandSidebar = function () {
                    n.default("body").hasClass("sidebar-collapse") &&
                        n
                            .default(this._config.sidebarButtonSelector)
                            .PushMenu("expand");
                }),
                (e._jQueryInterface = function (t) {
                    return this.each(function () {
