  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="jumbotron">
        ...
        <p class="lead">
          This is a simple example of push notification implementation of a
          "Success" message using Laravel + Vue.js + Pusher
        </p>
      </div>
      <div class="col-sm-6 col-sm-offset-3">
        ...
        <button
          @click="addMessage(newMsgName, newMsgEmail, newMsgDesc)"
...
export default {
  ...
  methods: {
    addMessage(msgName, msgEmail, msgDesc) {
      ...
      if (!msgName || !msgEmail || !msgDesc) return;
    ...
    listenForChanges() {
      Echo.channel("contact-form").listen("MessagePublished", (post) => {
        console.log(post);
